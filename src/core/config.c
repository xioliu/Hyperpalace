...
const hp_vm_config_t vm_configs[] = {
    {
        ...
        .num_ram_regions = 2, .ram_regions = {{0x50000000, 0x2000000, HP_MEM_READ|HP_MEM_WRITE|HP_MEM_EXEC}, {0x70000000, 0x1000, HP_MEM_READ|HP_MEM_WRITE|HP_MEM_SHAREABLE}},
    ...
    },
    {
        ...
        .num_ram_regions = 2, .ram_regions = {{0x60000000, 0x2000000, HP_MEM_READ|HP_MEM_WRITE|HP_MEM_EXEC}, {0x70000000, 0x1000, HP_MEM_READ|HP_MEM_WRITE|HP_MEM_SHAREABLE}},
        .num_device_regions = 1, .device_regions = {{UART0_BASE, UART0_SIZE, HP_MEM_READ|HP_MEM_WRITE|HP_MEM_DEVICE|HP_MEM_SHAREABLE}},
        .num_irqs = 2,
        .irqs = { VTIMER_IRQ, 64 },
    },
